...
public enum Logger {
    ...
    private static String nameOfLogger = "Java Logger";
    /**
    ...
    public static void setNameOfLogger(String newNameOfLogger) {
        nameOfLogger = newNameOfLogger;
    }
    ...
    public static String getNameOfLogger() {
        return nameOfLogger;
    }
    ...
    private void WriteExceptionMessageLogs(Exception e, String message, boolean writeToFile) {
        String fullMessage;
        if (enableStackTraces) {
            fullMessage = DateSeverityFormat() + message + (message.charAt(message.length()-1) != '.' ? ". " : " ") + "Exception: " + e.getMessage() + "\n" + GetStackTraceAsString(e);
        } else {
            fullMessage = DateSeverityFormat() + message + (message.charAt(message.length()-1) != '.' ? ". " : " ") + " Exception: " + e.getMessage();
        }
        if (writeToFile) {
